;(function ($) {
    ...
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/eld_project.default', function ($wrapper) {
            cheng_project_slider_element($wrapper);
        });
    });

    function cheng_project_slider_element($wrapper){
        let $slider = $('.project__slider-element', $wrapper);

        let dotsClass = $slider.hasClass('project__slider') ? 'slick-dots container' : 'slick-dots';
